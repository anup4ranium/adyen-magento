 ...
 */
class Adyen_Payment_Model_Adyen_CcInstallment extends Adyen_Payment_Model_Adyen_Abstract
    implements Mage_Payment_Model_Billing_Agreement_MethodInterface {

    protected $_code = 'adyen_cc_installment';
    protected $_formBlockType = 'adyen/form_ccInstallment';
    protected $_infoBlockType = 'adyen/info_ccInstallment';
    protected $_paymentMethod = 'cc_installment';
    ...
    public function assignData($data) {
        ...
        $info->setAdditionalInformation('password', $data->getPassword());
    ...
    public function getPossibleInstallments() {
        ...
        $result = Mage::helper('adyen/installments')->getInstallmentForCreditCardTypegetInstallmentForCreditCardType($ccType);
